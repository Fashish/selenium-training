...
public class NewAccountDDT {
	...
	WebElement nameElement, emailElement, phoneElement, passwordElement, verifyPasswordElement, countryElement, 
		maleRadio, femaleRadio, weeklyCheckbox, monthlyCheckbox, occasionalCheckbox, submitButton;
	WebDriver driver;
	...
	phone + " "+ gender + " " + password + " " + country + " " + weeklyEmail + " " + monthlyEmail + " " + occasionalEmail);
	...
	public static List<String[]> getData() {
		return utilities.CSV.get("/Users/fash/Dev/eclipse-workspace/SeleniumTraining/files/UserAccounts.csv");
	}
